...
<form action="http://brinidesigner.us7.list-manage.com/subscribe/post?u=dc2658700b82673e230562377&amp;id=2bc12367fa" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
	<h4>Subscribe to receive news, updates and special offers.</h4>
...
<div class="wrap">
	...
	<h2><?php _e('Add New Portfolio Item', 'awesome-filterable-portfolio'); ?></h2>
	<div class="metabox-holder has-right-sidebar">
		...
		<div id="post-body">
			<div id="post-body-content">
				...
				<div class="postbox">
					<h3><span><?php _e('Add New Portfolio Item', 'awesome-filterable-portfolio'); ?></span></h3>
					<div class="inside">
					<form action="#" method="post" enctype="multipart/form-data">
						  <p>
							<label for="title"><b><?php _e('Project Name :', 'awesome-filterable-portfolio'); ?></b></label><br>
							<input type="text" name="title" id="title" class="regular-text"><br>
						  </p>
						  <p>
							<label for="client"><b><?php _e('Client :', 'awesome-filterable-portfolio'); ?></b></label><br>
							<input type="text" name="client" id="client" class="regular-text">
						  </p>
						  <p>
							<label for="date"><b><?php _e('Date :', 'awesome-filterable-portfolio'); ?></b></label><br>
							<input type="text" name="date" id="date"><br />
   						  </p>
						  <p>
							<label for="link"><b><?php _e('Project Link :', 'awesome-filterable-portfolio'); ?></b></label><br>
							<input type="text" name="link" id="link" class="regular-text"><br>
							<span class="description"><?php _e('Add a URL to your project. If left empty no date will be displayed', 'awesome-filterable-portfolio'); ?></span>
						  </p>
						  <p>
							<label for="category"><b><?php _e('Category :', 'awesome-filterable-portfolio'); ?></b></label><br>
						  ...
						  <p>
							<label for="image"><b><?php _e('Image', 'awesome-filterable-portfolio'); ?></b></label><br />
							<input type="text" name="image_adr" id="image_adr" class="regular-text" /><input type="button" name="image" id="image" class="button-secondary" value="<?php _e('Upload Image', 'awesome-filterable-portfolio'); ?>" /><br />
							<span class="description"><?php _e('This is the image that will be displayed when you show the project details.', 'awesome-filterable-portfolio'); ?></span>
						  </p>
                          <p>
							<label for="thumbnail"><b><?php _e('Thumbnail', 'awesome-filterable-portfolio', 'awesome-filterable-portfolio'); ?></b></label><br />
							<input type="text" name="thumbnail_adr" id="thumbnail_adr" class="regular-text" /><input type="button" name="thumbnail" id="thumbnail" class="button-secondary" value="<?php _e('Upload Thumbnail', 'awesome-filterable-portfolio'); ?>" /><br />
							<span class="description"><?php _e('Use a small image for preview purpose. You may select an image from the Media Library and select Thumbnail for the image size.', 'awesome-filterable-portfolio'); ?></span>
						  </p>
						  <p>
							<label for="description"><b><?php _e('Description :', 'awesome-filterable-portfolio'); ?></b></label><br>
	...
	?>
	<h2><?php _e('Edit Portfolio Item', 'awesome-filterable-portfolio'); ?><a href="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=afp_add_new_portfolio_item" title="" class="add-new-h2"><?php _e('Add New', 'awesome-filterable-portfolio'); ?></a></h2>
	<?php if(isset($msg)){ ?><div style="padding: 5px" class="updated"><b><?php if ($msg=='added') { _e('Portfolio Item added successfully', 'awesome-filterable-portfolio'); } else { _e('Portfolio Item edited successfully', 'awesome-filterable-portfolio'); } ?></b></div><?php } ?>
	<div class="metabox-holder has-right-sidebar">
		<?php afp_help_meta_box(); ?>
		...
		<div id="post-body">
			<div id="post-body-content">
				...
				<div class="postbox">
					<h3><span><?php _e('Edit Portfolio Item', 'awesome-filterable-portfolio'); ?></span></h3>
					<div class="inside">
					<form action="#" method="post" enctype="multipart/form-data">
						  <p>
							<label for="title"><b><?php _e('Project Name :', 'awesome-filterable-portfolio'); ?></b></label><br>
						  ...
						  <p>
							<label for="image"><b><?php _e('Image', 'awesome-filterable-portfolio'); ?></b></label><br />
							<input type="text" name="image_adr" id="image_adr" class="regular-text" value="<?php echo($item->item_image); ?>"/><input type="button" name="image" id="image" class="button-secondary" value="<?php _e('Upload Image', 'awesome-filterable-portfolio'); ?>" /><br />
							<span class="description"><?php _e('This is the image that will be displayed when you show the project details.', 'awesome-filterable-portfolio'); ?></span>
						  </p>
                          <p>
							<label for="thumbnail"><b><?php _e('Thumbnail', 'awesome-filterable-portfolio'); ?></b></label><br />
							<input type="text" name="thumbnail_adr" id="thumbnail_adr" class="regular-text" value="<?php echo($item->item_thumbnail); ?>" /><input type="button" name="thumbnail" id="thumbnail" class="button-secondary" value="<?php _e('Upload Thumbnail', 'awesome-filterable-portfolio'); ?>" /><br />
							<span class="description"><?php _e('Use a small image for preview purpose. You may select an image from the Media Library and select Thumbnail for the image size.', 'awesome-filterable-portfolio'); ?></span>
						  </p>
						  <p>
							<label for="description"><b><?php _e('Description :', 'awesome-filterable-portfolio'); ?></b></label><br>
...
<div class="wrap">
	...
	?>
	<h2><?php _e('Portfolio Items ', 'awesome-filterable-portfolio'); ?><a href="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=afp_add_new_portfolio_item" title="" class="add-new-h2"><?php _e('Add New', 'awesome-filterable-portfolio'); ?></a></h2>
	...
	<?php
		...
		?>
		<h2><?php _e('Delete Confirmation', 'awesome-filterable-portfolio'); ?></h2>
		<h3><?php _e('Are you sure you want to delete this portfolio item?', 'awesome-filterable-portfolio'); ?></h3>
		<a class="button-primary" href="<?php echo( get_bloginfo('url') . '/wp-admin/admin.php?page=afp&action=delete&item_id=' . $item_id ); ?>"><?php _e( 'Delete', 'awesome-filterable-portfolio'); ?></a> 
		<a class="button-secondary" href="<?php echo( get_bloginfo('url') . '/wp-admin/admin.php?page=afp'); ?>"><?php _e( 'Cancel', 'awesome-filterable-portfolio'); ?></a> 
		<?php
	}
}
...
<div class="wrap">
	...
	<h2><?php _e('Add New Category', 'awesome-filterable-portfolio'); ?></h2>
	...
	<div class="metabox-holder has-right-sidebar">
		...
		<div id="post-body">
			<div id="post-body-content">
				...
				<div class="postbox">
					<h3><span><?php _e('Add New Category', 'awesome-filterable-portfolio'); ?></span></h3>
					<div class="inside">
					<form action="#" method="post" enctype="multipart/form-data">
						  <p>
							<label for="title"><b><?php _e('Category name :', 'awesome-filterable-portfolio'); ?></b></label><br>
							<input type="text" name="title" id="title" class="regular-text"><br>
						  </p>
						  <p>
							<label for="description"><b><?php _e('Description :', 'awesome-filterable-portfolio'); ?></b></label><br>
...
<div class="wrap">
	...
	<h2><?php _e('Edit Category', 'awesome-filterable-portfolio'); ?><a href="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=afp_add_new_category" title="" class="add-new-h2"><?php _e('Add New', 'awesome-filterable-portfolio'); ?></a></h2>
	<?php if(isset($msg)){ ?><div style="padding: 5px" class="updated"><b><?php if ($msg=='added') { _e('Category added successfully', 'awesome-filterable-portfolio'); } else { _e('Category edited successfully', 'awesome-filterable-portfolio'); } ?></b></div><?php } ?>
	<div class="metabox-holder has-right-sidebar">
	<?php afp_help_meta_box(); ?>
		<div id="post-body">
			<div id="post-body-content">
				...
				<div class="postbox">
					<h3><span><?php _e('Edit Category', 'awesome-filterable-portfolio'); ?></span></h3>
					<div class="inside">
					<form action="#" method="post" enctype="multipart/form-data">
						  <p>
							<label for="title"><b><?php _e('Category name :', 'awesome-filterable-portfolio'); ?></b></label><br>
...
<div class="wrap">
	...
	?>
	<h2><?php _e('Categories ', 'awesome-filterable-portfolio'); ?><a href="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=afp_add_new_category" title="" class="add-new-h2"><?php _e('Add New', 'awesome-filterable-portfolio'); ?></a></h2>
	<?php 
	...
	<?php
		...
		?>
		<h2><?php _e('Delete Confirmation', 'awesome-filterable-portfolio'); ?></h2>
		<h3><?php _e('Are you sure you want to delete this category?', 'awesome-filterable-portfolio'); ?></h3>
		<a class="button-primary" href="<?php echo( get_bloginfo('url') . '/wp-admin/admin.php?page=afp_categories&action=delete&cat_id=' . $cat_id ); ?>"><?php _e( 'Delete', 'awesome-filterable-portfolio' ); ?></a> 
		<a class="button-secondary" href="<?php echo( get_bloginfo('url') . '/wp-admin/admin.php?page=afp_categories'); ?>"><?php _e( 'Cancel', 'awesome-filterable-portfolio' ); ?></a> 
		<?php
	}
}
...
<div class="wrap">
	...
	<h2><?php _e('Options', 'awesome-filterable-portfolio'); ?></h2>
	...
	<div class="metabox-holder has-right-sidebar">
		...
		<div id="post-body">
			<div id="post-body-content">
				...
				<div class="postbox">
					<h3><span><?php _e('Portfolio Options', 'awesome-filterable-portfolio'); ?></span></h3>
					<div class="inside">
					<form action="#" method="post" enctype="multipart/form-data">
                    	<table cellpadding="3">
                        	<tr>
                            	<td style="width:140px;"><b><?php _e('Sort Categories:', 'awesome-filterable-portfolio'); ?></b></td>
                                <td><input type="checkbox" name="sort_cat" id="sort_cat" <?php if($afpOptions['sort_cat']=='on') { echo('checked'); } ?>>
                                <label for="sort_cat"><?php _e('Sort categories by name', 'awesome-filterable-portfolio'); ?></label>
                                </td>
                            </tr>
                            <tr>
                            	<td style="width:140px;" valign="top"><b><?php _e('Sort Portfolio Items by:', 'awesome-filterable-portfolio'); ?></b></td>
                                <td>
                                <select name="sort_items" id="sort_items">
                                	<option value="title" <?php if($afpOptions['sort_items']=='title'){ echo('selected'); } ?>><?php _e('Project Name', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="date" <?php if($afpOptions['sort_items']=='date'){ echo('selected'); } ?>><?php _e('Date', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="client" <?php if($afpOptions['sort_items']=='client'){ echo('selected'); } ?>><?php _e('Client Name', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="id" <?php if($afpOptions['sort_items']=='id'){ echo('selected'); } ?>></option>
                                </select>
                                <br /><span class="description"><?php _e('Select a creteria to sort the portfolio items. Choose the empty option to sort by the items\' order of creation.', 'awesome-filterable-portfolio'); ?></span>
                                </td>
                            </tr>
                        </table>
                        <br />
                    	<table cellpadding="3">
                            <tr>
                            	<td style="width:140px;" valign="top"><b><?php _e('Project Links open in:', 'awesome-filterable-portfolio'); ?></b></td>
                                <td>
                                <select name="project_link" id="project_link">
                                	<option value="blank" <?php if($afpOptions['project_link']=='blank'){ echo('selected'); } ?>><?php _e('New Tab / Window', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="self" <?php if($afpOptions['project_link']=='self'){ echo('selected'); } ?>><?php _e('Same Tab / Window', 'awesome-filterable-portfolio'); ?></option>
                                </select>
                                <br /><span class="description"><?php _e('This option specifies where the Project Link for a Portfolio Item should be open.', 'awesome-filterable-portfolio'); ?></span>
                                </td>
                            </tr>
                        </table>
                        <br />
                        <table cellpadding="3">
                        	<tr>
                                ...
                                <select name="anim_speed">
                                    ...
                                    <option value="300" <?php if($afpOptions['anim_speed']=='300'){ echo('selected'); } ?>><?php _e('Fast', 'awesome-filterable-portfolio'); ?></option>
                                </select>
                                <br />
                                <input type="checkbox" name="anim_easing" id="anim_easing" <?php if($afpOptions['anim_easing']=='on') { echo('checked'); } ?>>
                                <label for="anim_easing"><?php _e('Use easing for animations', 'awesome-filterable-portfolio'); ?></label>
                                </td>
                            </tr>
                            <tr>
                            	<td style="width:140px;" valign="top"><b><?php _e('Initial Image Effect:', 'awesome-filterable-portfolio'); ?></b></td>
                                <td>
                                <select name="startFX">
                                    <option value="normal" <?php if($afpOptions['startFX']=='normal'){ echo('selected'); } ?>><?php _e('normal', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="transparent" <?php if($afpOptions['startFX']=='transparent'){ echo('selected'); } ?>><?php _e('transparent', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="overlay" <?php if($afpOptions['startFX']=='overlay'){ echo('selected'); } ?>><?php _e('overlay', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="grayscale" <?php if($afpOptions['startFX']=='grayscale'){ echo('selected'); } ?>><?php _e('grayscale', 'awesome-filterable-portfolio'); ?></option>
                                </select>
                                </td>
                            </tr>
                            <tr>
                            	<td style="width:140px;" valign="top"><b><?php _e('Image Hover Effect:', 'awesome-filterable-portfolio'); ?></b></td>
                                <td>
                                <select name="hoverFX">
                                    <option value="normal" <?php if($afpOptions['hoverFX']=='normal'){ echo('selected'); } ?>><?php _e('normal', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="popout" <?php if($afpOptions['hoverFX']=='popout'){ echo('selected'); } ?>><?php _e('popout', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="sliceDown" <?php if($afpOptions['hoverFX']=='sliceDown'){ echo('selected'); } ?>><?php _e('sliceDown', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="sliceDownLeft" <?php if($afpOptions['hoverFX']=='sliceDownLeft'){ echo('selected'); } ?>><?php _e('sliceDownLeft', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="sliceUp" <?php if($afpOptions['hoverFX']=='sliceUp'){ echo('selected'); } ?>><?php _e('sliceUp', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="sliceUpLeft" <?php if($afpOptions['hoverFX']=='sliceUpLeft'){ echo('selected'); } ?>><?php _e('sliceUpLeft', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="sliceUpRandom" <?php if($afpOptions['hoverFX']=='sliceUpRandom'){ echo('selected'); } ?>><?php _e('sliceUpRandom', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="sliceUpDown" <?php if($afpOptions['hoverFX']=='sliceUpDown'){ echo('selected'); } ?>><?php _e('sliceUpDown', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="sliceUpDownLeft" <?php if($afpOptions['hoverFX']=='sliceUpDownLeft'){ echo('selected'); } ?>><?php _e('sliceUpDownLeft', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="fold" <?php if($afpOptions['hoverFX']=='fold'){ echo('selected'); } ?>><?php _e('fold', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="foldLeft" <?php if($afpOptions['hoverFX']=='foldLeft'){ echo('selected'); } ?>><?php _e('foldLeft', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="boxRandom" <?php if($afpOptions['hoverFX']=='boxRandom'){ echo('selected'); } ?>><?php _e('boxRandom', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="boxRain" <?php if($afpOptions['hoverFX']=='boxRain'){ echo('selected'); } ?>><?php _e('boxRain', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="boxRainReverse" <?php if($afpOptions['hoverFX']=='boxRainReverse'){ echo('selected'); } ?>><?php _e('boxRainReverse', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="boxRainGrow" <?php if($afpOptions['hoverFX']=='boxRainGrow'){ echo('selected'); } ?>><?php _e('boxRainGrow', 'awesome-filterable-portfolio'); ?></option>
                                    <option value="boxRainGrowReverse" <?php if($afpOptions['hoverFX']=='boxRainGrowReverse'){ echo('selected'); } ?>><?php _e('boxRainGrowReverse', 'awesome-filterable-portfolio'); ?></option>
                                </select>
                                </td>
                            </tr>
                        </table>
